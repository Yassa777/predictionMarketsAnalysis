...
- `facet1_unified_calibration_curves.pdf`
- `facet1_unified_calibration_curves.png`
- `facet1_monthly_drift.pdf`
- `facet1_monthly_drift.png`
- `facet1_liquidity_calibration.pdf`
